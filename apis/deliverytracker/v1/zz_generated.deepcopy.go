...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeliveryInfo) DeepCopyInto(out *DeliveryInfo) {
	*out = *in
	if in.GitTags != nil {
		in, out := &in.GitTags, &out.GitTags
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeliveryInfo.
func (in *DeliveryInfo) DeepCopy() *DeliveryInfo {
	if in == nil {
		return nil
	}
	out := new(DeliveryInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DeliverySpec) DeepCopyInto(out *DeliverySpec) {
	*out = *in
	if in.Environment != nil {
		...
		*out = make(map[string]DeliveryInfo, len(*in))
